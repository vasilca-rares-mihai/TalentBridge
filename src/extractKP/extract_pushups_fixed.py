...
nume_fisier_csv = r"C:\Users\rares\Desktop\TalentBridge\src\extractKP\csv\dataset_pushups_fixed.csv"
...
# ANTET CSV: 19 features * 30 frames
...
print("Incep extragerea caracteristicilor...")
        ...
        for nume_clip in os.listdir(cale_folder_clasa):
            ...
            while cap.isOpened():
                ...
                if results.pose_landmarks:
                    ...
                    norm_umar = normalizeaza_3d(p_umar, p_sold, s_curent)
                    norm_cot = normalizeaza_3d(p_cot, p_sold, s_curent)
                    norm_inch = normalizeaza_3d(p_inch, p_sold, s_curent)
                    norm_gen = normalizeaza_3d(p_gen, p_sold, s_curent)
                    norm_glez = normalizeaza_3d(p_glez, p_sold, s_curent)
