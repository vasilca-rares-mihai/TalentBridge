...
print("Incarcam seturile izolate de Train si Test pentru Saritura in lungime...")
...
plt.title('Evolutia Acuratetei - Saritura in lungime')
plt.xlabel('Epoci')
...
plt.title(f'Matrice de Confuzie Saritura - Accuracy: {accuracy * 100:.2f}%')

plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig('matrice_confuzie_jump_30f.png', dpi=300)
plt.show()

print("Modelul si matricea pentru saritura in lungime au fost salvate cu succes.")