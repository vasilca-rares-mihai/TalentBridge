...
class LongJumpAnalyzer(VideoAnalyzer):
    ...
    Asa numaram doar sarituri reale, FARA sa taiem caderile (care au zbor mic din natura lor).
      ...
      * Scor leaderboard = cea mai buna distanta.
    """
    ...
    def __init__(self, video_path, output_path=None):
        ...
        self.air_peak = 0.0
        self.MIN_JUMP_DIST = 0.20   # sub asta = pe loc (prep / ridicare / tremur) -> nu e saritura
    ...
    # ---------- features (IDENTIC cu extractorul) ----------
    ...
    def _finalizeaza(self):
        ...
        # saritura reala = deplasare IN FATA (restul raman pe loc; mersul inapoi nu are zbor)
        ...
        if verdict == "perfect":
            self.corecte += 1
            # doar sariturile CORECTE conteaza pt cea mai buna distanta
