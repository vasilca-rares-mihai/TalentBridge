    ...
    Box(modifier = Modifier.fillMaxSize().background(background_color)) {
        ...
        if (selectedTrialRequirements != null) {
            ...
            AlertDialog(
                ...
                text = {
                    Column {
                        currentTrial.requirements.toMap().filterKeys { it in ACTIVE_ATTRS }.forEach { (attr, requiredValue) ->
            ...
            AlertDialog(
                ...
                text = {
                    Column(modifier = Modifier.padding(20.dp).verticalScroll(rememberScrollState())) {
                        ...
                        requirementsMap.filterKeys { it in ACTIVE_ATTRS }.forEach { (fieldName, value) ->
                            OutlinedTextField(
