                        ...
                        Column(modifier = Modifier.padding(16.dp)) {
                            ...
                            Row(modifier = Modifier.fillMaxWidth()) {
                                Column(modifier = Modifier.weight(1f).padding(end = 8.dp)) {
                                    ...
                                    AttributeStat("Shot Power", currentAttributes.shot_power.toString())
                                    AttributeStat("Long Shots", currentAttributes.long_shots.toString())
                                    AttributeStat("Penalties", currentAttributes.penalties.toString())
                                    AttributeStat("Short Pass", currentAttributes.short_pass.toString())
                                    AttributeStat("Long Pass", currentAttributes.long_pass.toString())
                                }
                                Column(modifier = Modifier.weight(1f).padding(start = 8.dp)) {
                                    ...
                                    AttributeStat("Ball Control",currentAttributes.ball_control.toString())
                                    AttributeStat("Dribbling", currentAttributes.dribbling.toString())
                                    AttributeStat("Heading Acc",currentAttributes.heading_acc.toString())
                                    AttributeStat("Jumping", currentAttributes.jumping.toString())
                                    AttributeStat("Stamina", currentAttributes.stamina.toString())
